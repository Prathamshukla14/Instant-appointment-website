...
export const REVIEWS = [
  ...
  { quote: "I've worked with big name companies over the past couple of years. All made big promises, all ended up the same: more bad leads than good ones, and broken promises. Nick with InstantAppointment AI did something I'd never seen — he gave me a trial for a reasonable amount, and in 2 days I had bids over $50K in tree work, with over $15K accepted by day 3. I'd put them up there with the biggest lead generation companies out there, at a fraction of the cost. I assure you, you will not be disappointed.", name: "Wade Beene", company: "Trees by Wade LLC", tag: "Tree Service" },
  { quote: "These guys do a great job getting leads. We are very pleased with both their communication and results.", name: "Masterco Field", company: "", tag: "" },
  { quote: "The team from Nick is just outstanding, he goes above and beyond to keep the workflow going. I've used others before, and they are nothing like Nick and the team. Honestly, thanks guys!", name: "Shane Hulbert", company: "A Southern Style Tree Service LLC", tag: "General Contractor" },
  { quote: "They actually try and help, instantly. InstantAppointment AI follows up with you and the customer if needed. Very affordable, and I'm sure they have plans and ideas on how they can help grow your business as well.", name: "Ike Jasper", company: "", tag: "" },
  { quote: "IA has been providing Natures Image Trees with great leads. These aren't leads where a bunch of contractors are arriving at the same time, every time things slow down IA is quick to respond with more. They also have great prices on package deals. Very happy with this app.", name: "Christian Lopez", company: "Natures Image Trees", tag: "Tree Service" },
  { quote: "Great service! Love the quality leads!", name: "Stephan Machado", company: "", tag: "" },
  { quote: "I signed up for the trial and closed 14 out of 18 leads in the first week. I've used several similar services with nowhere near the results. These guys are awesome!", name: "Ken Biggs", company: "Sunnyside Property Services", tag: "General Contractor" },
  { quote: "Great company! They took my junk removal business from just me solo running the truck, to four months later having a full crew and me off the truck entirely. Such a great team, and they work with you too. Just always be transparent with them, and you'll make it!", name: "Antonio Frias", company: "", tag: "Junk Removal" },
  { quote: "They are a very good company. I would recommend them to everybody.", name: "Rick Bradley", company: "", tag: "" },
];
