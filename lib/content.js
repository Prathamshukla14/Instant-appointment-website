import {
  ...
  ChefHat, Home, Layers, Ruler, HardHat,
} from "lucide-react";
...
/* ---- Industries / niches: each becomes /industries/[slug], indexed separately ---- */
export const INDUSTRIES = [
  {
    slug: "kitchen-bath-remodeling",
    name: "Kitchen & Bath",
    icon: ChefHat,
    eyebrow: "KITCHEN & BATH REMODELERS",
    title: "Booked kitchen and bath consultations, on your calendar.",
    lede: "Homeowners planning a kitchen or bath remodel are high intent and high ticket. We put them in front of you, qualified and confirmed, before they call three competitors.",
    intro: "Kitchen and bath is the most competitive remodeling niche there is, which is exactly why shared leads fail here worst. The same homeowner gets sold to five contractors, and the one who answers first wins on speed, not fit. We run exclusive campaigns under your brand so the only estimate on the homeowner's calendar is yours.",
    pains: [
      { t: "Shared leads race to the bottom", b: "Angi and Houzz sell the same kitchen lead to several contractors. You spend the afternoon on quotes that were decided before you arrived." },
      { t: "Tire kickers and browsers", b: "Design dreamers with no budget and no timeline eat the same hours as a homeowner ready to sign. Nothing filters them out." },
      { t: "Slow follow up kills the deal", b: "A homeowner excited about a new kitchen at 9am has moved on by lunch. Most contractors cannot respond inside that window." },
    ],
    approach: [
      { t: "Intent built targeting", b: "Meta and Google campaigns aimed at homeowners actively planning kitchen and bath work in your market, not renters or bargain hunters." },
      { t: "Budget and scope qualified", b: "Our team confirms the homeowner owns the home, has a realistic budget for a full remodel, and is ready inside your timeline before booking." },
      { t: "Confirmed, and they show", b: "Every appointment is reminded and reconfirmed. You are billed only when the homeowner actually shows for the in home consultation." },
    ],
    projects: ["Full kitchen remodels", "Bathroom renovations", "Cabinet and countertop replacement", "Primary bath and walk in showers"],
  },
  {
    slug: "whole-home-remodeling",
    name: "Whole Home",
    icon: Home,
    eyebrow: "WHOLE HOME REMODELERS",
    title: "Whole home projects worth showing up for.",
    lede: "Whole home remodels are your biggest tickets and your longest sales cycles. We book homeowners who are serious about a full renovation, not a single room quote.",
    intro: "A whole home remodel can be a six figure project, so the cost of a wasted appointment is high and the cost of a missed one is higher. We qualify hard on scope and budget up front, so the consultations that reach your calendar are homeowners genuinely planning a full renovation, ready to talk timeline and investment.",
    pains: [
      { t: "Scope mismatch", b: "Leads that say whole home but mean a single bathroom waste a full site visit and a detailed estimate." },
      { t: "Long deliberation, cold leads", b: "Big projects take time to decide, and without nurture the homeowner goes quiet and the lead dies." },
      { t: "Price shoppers with no budget", b: "Homeowners curious what a full remodel costs, with no intention or ability to move, drain your estimating time." },
    ],
    approach: [
      { t: "Serious buyers only", b: "We qualify on project scope and realistic budget so a whole home appointment means a whole home budget." },
      { t: "Nurtured until ready", b: "Automated follow up and retargeting keep your brand in front of the homeowner through a longer decision window." },
      { t: "Exclusive in your market", b: "One remodeler per territory. The homeowner is not comparing you against two other companies we also work with." },
    ],
    projects: ["Full home renovations", "Multi room remodels", "Open concept conversions", "Interior and layout overhauls"],
  },
  {
    slug: "home-additions",
    name: "Additions",
    icon: Ruler,
    eyebrow: "HOME ADDITION BUILDERS",
    title: "Homeowners ready to add square footage.",
    lede: "Additions are high value, permit heavy, and only worth pursuing when the homeowner is committed. We find the ones who are and book them onto your calendar.",
    intro: "Room additions, second stories, and ADUs are among the most valuable jobs a remodeler can land, but also the easiest to waste time on when the homeowner is only dreaming. We put your ads in front of homeowners with the intent and the property to actually build, and confirm the fundamentals before the appointment is set.",
    pains: [
      { t: "Feasibility unknowns", b: "Homeowners often do not know if their lot or budget supports an addition, so unqualified appointments end before they begin." },
      { t: "Big ticket hesitation", b: "The size of an addition project means longer decisions and more homeowners who stall out without follow up." },
      { t: "Generic leads miss intent", b: "Shared platforms cannot tell an addition buyer from a handyman inquiry. You pay the same for both." },
    ],
    approach: [
      { t: "Addition specific campaigns", b: "Creative and targeting built around room additions, second stories, and ADUs, so the homeowner self selects on intent." },
      { t: "Qualified on the essentials", b: "Home ownership, budget range, and project readiness confirmed before the consultation reaches your calendar." },
      { t: "Pay only on shows", b: "Additions are too valuable to gamble on no shows. You pay a flat fee only when the homeowner shows up." },
    ],
    projects: ["Room additions", "Second story additions", "ADUs and in law suites", "Garage conversions"],
  },
  {
    slug: "basement-finishing",
    name: "Basements",
    icon: Layers,
    eyebrow: "BASEMENT FINISHING CONTRACTORS",
    title: "Finished basement projects, ready to book.",
    lede: "Basement finishing is a fast moving, high volume niche. We keep your calendar full of homeowners ready to turn unused space into living space.",
    intro: "Basement finishing sits in a sweet spot: high enough ticket to be worth your time, common enough to run real volume. That combination makes speed and exclusivity everything. We contact every homeowner in minutes and run your market alone, so you are not splitting a hot niche with three other contractors.",
    pains: [
      { t: "High volume, high competition", b: "Because basements are popular, shared platforms flood the niche and homeowners get calls from everyone at once." },
      { t: "Speed decides who wins", b: "Basement homeowners tend to move fast. The contractor who reaches them first books the estimate." },
      { t: "Wide range of scope", b: "From a simple rec room to a full apartment, without qualification you cannot tell which appointments are worth the drive." },
    ],
    approach: [
      { t: "First to the homeowner", b: "Speed to lead automation contacts every basement inquiry within minutes, so you win the race instead of losing it." },
      { t: "Scope confirmed up front", b: "We capture what the homeowner actually wants finished, so you walk in already knowing the project." },
      { t: "Your market, only you", b: "Exclusive territory means the homeowner is not fielding calls from other contractors we sent." },
    ],
    projects: ["Full basement finishing", "Basement apartments and suites", "Rec rooms and home theaters", "Basement bathrooms and bars"],
  },
  {
    ...
    title: "A steady calendar of qualified project consultations.",
    lede: "For GCs ready to scale, the bottleneck is not skill, it is a predictable flow of qualified homeowners. That is exactly what we deliver.",
    intro: "General contractors handle everything, which is a strength and a targeting problem. Broad leads bring broad noise. We build campaigns around the project types you want more of, qualify each homeowner, and book them onto your calendar, so growth becomes a matter of capacity instead of luck.",
    pains: [
      { t: "Feast or famine pipeline", b: "Referrals dry up and word of mouth is unpredictable, leaving crews idle one month and slammed the next." },
      { t: "Too broad to target well", b: "Doing everything makes generic lead sources send everything, most of it a poor fit for your crew and margins." },
      { t: "No time to chase leads", b: "You are on the job, not by the phone, so leads go cold before anyone follows up." },
    ],
    approach: [
      { t: "Built around your best work", b: "We focus campaigns on the project types and margins you actually want, not whatever a shared platform hands over." },
      { t: "We do the chasing", b: "Automation plus a live team contacts, qualifies, and books every homeowner, so you never touch a cold lead." },
      { t: "Predictable, exclusive volume", b: "A steady flow of shown appointments in a territory that is yours alone, sized to what your crews can handle." },
    ],
    projects: ["Multi trade remodels", "Home renovations", "Exterior and structural work", "Repeat and referral overflow"],
  },
];
